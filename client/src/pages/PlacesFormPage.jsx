    ...
    return (
        <div>
            ...
            <form onSubmit={savePlace}>
                ...
                {preInput('Photos', 'More photos will be greater')}
                ...
                <div className="grid gap-5 grid-cols-2 md:grid-cols-4 ">
                    ...
                    <div>
                        ...
                        <input type="text" value={checkOut} onChange={ev => setCheckOut(ev.target.value)} placeholder="04:00" />
                    </div>
                    <div>
                        <h3 className="mt-2 -mb-1  ">Max number of Guests</h3>
                        <input type="number" value={maxGuests} onChange={ev => setMaxGuests(ev.target.value)} placeholder="2,3" />
                    </div>
                ...
                <div className="flex justify-center">
                    <button className=" flex justify-center max-w-40 mt-4 primary">Save</button>
                </div>
